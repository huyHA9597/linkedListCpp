...
{
public:
    const linkedListType<Type>& operator=(linkedListType<Type>& otherList);
    ...
    void destroyList();
    // Function to deleter all the nodes from the list.
    // Postcondition: first = nullptr, last = nullptr, count = 0;
    ...
    // Function to delte deleteItem from the list.
    ...
    linkedListType();
    // Default constructor
    // Initializes the list to an empy state.
    // POstcondition: first = nullptr, last = nullptr, count = 0
...
void linkedListType<Type>::destroyList()
{
    ...
    while (first != nullptr)    // while there are nodes in
                                // the list
    {
        temp = first;           // set temp to the curretn node
        first = first->link;    // advance first to the current node
